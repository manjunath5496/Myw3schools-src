 ...
 <?php include 'upload.php'; ?>
    <div class="row">
    	<div class="page-container row-12">
            ...
            <a class ="pointer" onclick="DownloadAndRedirect()" target="__blank">Compressed folder (zipped)</a>
            </p>
			</br> </br>
	    	    <?php 
            }
            ?>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="file-upload"> <label for="upload1" class="file-upload__label">Choose Files </label> 
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="upload1" class="file-upload__input" type="file" name="img[]" multiple>
				</div>			
					</br> </br>	
					<div class="input-group-prepend">
						   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" class="knob knob-data" class="btn btn-primary" style="font-size:11pt;color:white;background-color:#ff7a59;border:2px solid #ff7a59;" value="Upload">
						</div>	
