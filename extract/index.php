...
<script>
                ...
                </script></div> </br> </br> <div id="former-text-list" class="bag_24"> <div class="property-content-divider"></div> <div id='before-cont-box-1' class='column_3_of_3 home-cont-box'> <div class='list-text-cover'> <div class="cont_col_1 widget_text secondary_object_category"> <div class="textwidget"> <p style="color:black; text-align:center; font-size:20px;"> </p> <div class="drop-accordion"> <h5 class="panel-title" id="contact-form" style="text-align: left; ">&nbsp;&nbsp;&nbsp;</h5> <div class="contacten" name="quick_enq_side"> <div class="panel panel-default"> <div class="panel-heading"> <h3 class="panel-title" style="font-size:15px;font-weight:bold;"> </h3> </div> <div class="panel-body"><div class="container"><form method="post"><div class="form-field"><input name="webURL" class="form-control" type="url" placeholder="Enter Web Address" value="<?php echo $webURL; ?>" autocomplete="off" spellcheck="false" required><br><br></div> <input type="submit" class="knob knob-data" style="font-size:11pt;color:white; background-color:#99CCFF;border:2px solid #99CCFF;" name="submit" value="Get all the links"> <a href="index.php" style="text-decoration:none;"><button type="button" class="knob knob-data" style="font-size:11pt;color:white; background-color:#00A2E4;border:2px solid #00A2E4;">Refresh</button></a></form></br> </br><div class="boxed shaded">				
...
{ 
echo '<p style="font-size:15px; text-align:center;color:black"><strong>No URL Entered.</strong> </p>';
} 
