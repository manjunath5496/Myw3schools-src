...
</div> </br> </br> <div id="former-text-list" class="bag_24"> <div class="property-content-divider"></div> <div id='before-cont-box-1' class='column_3_of_3 home-cont-box'> <div class='list-text-cover'> <div class="cont_col_1 widget_text secondary_object_category"> <div class="textwidget"> <p style="color:black; text-align:center; font-size:20px;"> </p> <div class="drop-accordion"> <h5 class="panel-title" id="contact-form" style="text-align: left; ">&nbsp;&nbsp;&nbsp;</h5> <div class="contacten" name="quick_enq_side"> <div class="panel panel-default"> <div class="panel-heading"> <h3 class="panel-title" style="font-size:15px;font-weight:bold;"> </h3> </div> <div class="panel-body"><a href="add_subscribers.php" class="knob knob-data pointer" title="Add New Recipient" style="font-size:11pt;color:white;background-color:#ff5c5c;border:2px solid #ff5c5c;"> <i class="fa fa-plus" aria-hidden="true"></i> Add New Recipient </a></br> </br></br> </br><table id = "myTable1"><thead><tr style ="color:#3A5580;"> <th>Email</th> <th>Status</th> <th>Action</th> </tr> </thead> <tbody id="table-body">
    ...
    if (count($subResults) > 0) {
        foreach ($subResults as $rs) {
            ...
            <tr>
                ...
                <td><a href="manage_subscribers.php?del=<?php echo urlencode($rs["email_id"]); ?>" onclick="return confirm('Are you sure?');"><span  style='font-size:20px; color:#ec5252;'><i class='fa fa-times' aria-hidden='true'></i></span></a> </td>
            </tr>
            <?php
        }
    } else {
