        ...
        if (in_array($ext, $allowed_ext)) {
            if (@move_uploaded_file($_FILES["card_file"]["tmp_name"], "../" . $filePath)) {
                ...
                try {
                    ...
                    $stmt->execute();
                    if ($stmt->rowCount() > 0) {
                        $msg = successMessage("<strong>Card Added Successfully.</strong> <META HTTP-EQUIV='refresh' CONTENT='4;URL=add_cards.php' />");
                    } else if ($stmt->rowCount() == 0) {
                        $msg = successMessage("<strong>No Changes Affected.</strong> <META HTTP-EQUIV='refresh' CONTENT='4;URL=add_cards.php' />");
                    } else {
                        $msg = errorMessage("<strong>Failed to Add Card.</strong> <META HTTP-EQUIV='refresh' CONTENT='4;URL=add_cards.php' />");
                    }
                } catch (Exception $ex) {
                ...
                $msg = errorMessage("<strong>Error in Uploading Card! Please Try Again.</strong> <META HTTP-EQUIV='refresh' CONTENT='4;URL=add_cards.php' />");
            }
        } else {
            $msg = errorMessage("<strong>File Type Not Supported.</strong> <META HTTP-EQUIV='refresh' CONTENT='4;URL=add_cards.php' />");
        }
    }
}
...
</div> </br> </br> <div id="former-text-list" class="bag_24"> <div class="property-content-divider"></div> <div id='before-cont-box-1' class='column_3_of_3 home-cont-box'> <div class='list-text-cover'> <div class="cont_col_1 widget_text secondary_object_category"> <div class="textwidget"> <p style="color:black; text-align:center; font-size:20px;"> </p> <div class="drop-accordion"> <h5 class="panel-title" id="contact-form" style="text-align: left; ">&nbsp;&nbsp;&nbsp;</h5> <div class="contacten" name="quick_enq_side"> <div class="panel panel-default"> <div class="panel-heading"> <h3 class="panel-title" style="font-size:15px;font-weight:bold;"> </h3> </div> <div class="panel-body"> <?php echo $msg; ?> </br> </br> <form method="post" action="" name="f" enctype="multipart/form-data" > <input type="hidden" name="mode" value="add" /> <div class="form-field"><input type="text" name="card_title" id="card_title" class="form-control" placeholder="Title *" value="<?php echo $card_title; ?>" autocomplete="off" spellcheck="false" required/> <br><br></div><div class="file-upload"> <label for="upload1" class="file-upload__label">Choose Files </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="upload1" class="file-upload__input" type="file" name="card_file"/></div> </br> </br> <input type="submit" class="knob knob-data" style="font-size:11pt;color:white; background-color:#99CCFF;border:2px solid #99CCFF;" name="sub" value="Upload" /> &nbsp; <input type="button" name="" class="knob knob-data" style="font-size:11pt;color:white; background-color:#ffc65c;border:2px solid #ffc65c;" onclick="javascript:window.location = 'manage_cards.php';" value="Show Listing" /> </table> </form></br> </br> </div> </div> </div> </br> </br> </div> </div> </div> </div> </div> </br> <center> <img src="http://www.static.myw3schools.com/img/rsb.png" alt="myw3schools.com"> </center> </br> </br> </br> </div> </div> </div> <div class="clear"></div> <div class="property-content-divider"></div> <div class="clear"></div> <div class="clear"></div> <div id="page-footer" style="font-size:12px;background-color:#f1f1f1;"> <div id="footer" class="bag_24 footer-head"> <div itemtype="http://schema.org/WPFooter" itemscope="itemscope"> <div id="footer-content" class="grid_20"> <div> <div class="suggareas"> <p style="text-indent:10px;text-align: justify;-moz-text-align-last: right; text-align-last: left;"> </p> </div> <div class="clear"></div> <div style="font-size:12px;color:gray;text-align:center"> Copyright &#169; 2018 myw3schools. All rights reserved. </div> </div> </div> <div class="tail-to-head"> <a class="pointer" href="#top" style="text-decoration:none"> <font color="gray"> <i class="fa fa-arrow-up" aria-hidden="true"></i> Back to Top</font> </a> </div> </div> </div> </div> <script type='text/javascript' src='http://www.static.myw3schools.com/js/output.min1.js'></script> <script> $(window).bind("pageshow", function(event) { if (event.originalEvent.persisted) { window.location.reload() } }); </script> <script src="http://www.static.myw3schools.com/js/gtag.js?id=UA-131555544-1"></script> <script> window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); } gtag('js', new Date()); gtag('config', 'UA-131555544-1'); </script></body></html> 