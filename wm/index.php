...
if (isset($_POST['submit']))
{
    ...
    $img_source = $_FILES['file1']['tmp_name'];
    $img_type = strtolower($_FILES['file1']['type']);
    ...
    if($img_name!='')
    {
        ...
        switch($img_type)
        {
            ...
            case 'image/jpeg':
                ...
                break;
            case 'image/gif':
                $image_src =  imagecreatefromgif($img_source);
                break;
            default:
                $image_src = false;
        }
        ...
        if($image_src)
        {
            $watermark_src = imagecreatefrompng($watermark_image);
            ...
            imagecopy($image_src, $watermark_src, imagesx($image_src) - $watermark_width - $right_margin, imagesy($image_src) - $watermark_height - $bottom_margin, 0, 0, $watermark_width, $watermark_height);

            // save image to folder
            imagejpeg($image_src, $destination_image, 80);
...
<script>
...
</div> </br> </br> <div id="former-text-list" class="bag_24"> <div class="property-content-divider"></div> <div id='before-cont-box-1' class='column_3_of_3 home-cont-box'> <div class='list-text-cover'> <div class="cont_col_1 widget_text secondary_object_category"> <div class="textwidget"> <p style="color:black; text-align:center; font-size:20px;"> </p> <div class="drop-accordion"> <h5 class="panel-title" id="contact-form" style="text-align: left; ">&nbsp;&nbsp;&nbsp;</h5> <div class="contacten" name="quick_enq_side"> <div class="panel panel-default"> <div class="panel-heading"> <h3 class="panel-title" style="font-size:15px;font-weight:bold;"> </h3> </div> <div class="panel-body"><div class="container"> <div class="row"> <div class="col-xs-8 col-xs-offset-2 well" style="background: none;"> <form action="index.php" method="post" enctype="multipart/form-data"> <div class="file-upload"> <label for="upload1" class="file-upload__label">Choose File </label> <input id="upload1" class="file-upload__input" type="file" name="file1"></div></br> </br> <div class="form-group"> <input type="submit" class="knob knob-data" style="font-size:11pt;color:white;background-color:#ff7a59;border:2px solid #ff7a59;" name="submit" value="Upload" class="btn btn-danger"/> &nbsp; &nbsp; <input type="button" class="knob knob-data" onclick="location.href='c.php';" style="font-size:11pt;color:white;background-color:#3A5580;border:2px solid #3A5580;" value="Refresh" /></div></br> </br>
        ...
        <div class="col-xs-8 col-xs-offset-2 text-center well" style="background: none;">
            <img src="<?php echo $destination_image; ?>" width=100% />
        </div>
        <?php } ?>
