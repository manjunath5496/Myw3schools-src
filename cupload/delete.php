...
{
    try {
         $pdoConnect = new PDO("mysql:host=localhost;dbname=mywschoo_db","mywschoo_user","maczen5496");
    ...
    $pdoQuery = "DELETE FROM `jobs` WHERE `job_id` = :id";
...
if($result->rowCount() == 0)
		{
			echo '<h4 style = "text-align:center; color:#3A5580; ">No records found. </h4>';
			echo '<center><a class="knob knob-data pointer" style="padding:6px 6px;font-size:11pt;color:white;background-color:#ec5252;border:2px solid #ec5252;"  href="add.php" title ="Add Careers">&nbsp;&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"></i> Add&nbsp;&nbsp;&nbsp; </a></center>';
		}
