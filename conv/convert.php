...
<script>
                ...
                </script></div> </br> </br> <div id="former-text-list" class="bag_24"> <div class="property-content-divider"></div> <div id='before-cont-box-1' class='column_3_of_3 home-cont-box'> <div class='list-text-cover'> <div class="cont_col_1 widget_text secondary_object_category"> <div class="textwidget"> <p style="color:black; text-align:center; font-size:20px;"> </p> <div class="drop-accordion"> <h5 class="panel-title" id="contact-form" style="text-align: left; ">&nbsp;&nbsp;&nbsp;</h5> <div class="contacten" name="quick_enq_side"> <div class="panel panel-default"> <div class="panel-heading"> <h3 class="panel-title" style="font-size:15px;font-weight:bold;"> </h3> </div> <div class="panel-body">          
			
<?php if(!$download) {?>
<form method="post" action="">
<div class="boxed shaded"> <p style="font-size:15px; text-align:center;color:black"><strong>File Uploaded.</strong></p> </div>						
<img src="uploads/<?=$imageName;?>"  />
					...
					<input type="submit" class="knob knob-data" style="font-size:11pt;color:white; background-color:#99CCFF;border:2px solid #99CCFF;" value="Convert" />
			
		</form>
	<?php } ?>
	<?php if($download) {?>
	<div class="boxed shaded"> <p style="font-size:15px; text-align:center;color:black"><strong>Image Converted to <?php echo ucwords($convert_type); ?> </strong></p> </div>			
<img src="<?=$target_dir.'/'.$image;?>"  />
</br> </br>
<a href="download.php?filepath=<?php echo $target_dir.'/'.$image; ?>" />
					<button type="button" class="knob knob-data" style="font-size:11pt;color:white; background-color:#00A2E4;border:2px solid #00A2E4;">Download </button>					
					
</a> <a href="c.php" style="text-decoration:none;"><button type="button" class="knob knob-data" style="font-size:11pt;color:white; background-color:orange;border:2px solid orange;">Refresh</button></a>
