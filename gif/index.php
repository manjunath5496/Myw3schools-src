...
</div> </br> </br> <div id="former-text-list" class="bag_24"> <div class="property-content-divider"></div> <div id='before-cont-box-1' class='column_3_of_3 home-cont-box'> <div class='list-text-cover'> <div class="cont_col_1 widget_text secondary_object_category"> <div class="textwidget"> <p style="color:black; text-align:center; font-size:20px;"> </p> <div class="drop-accordion"> <h5 class="panel-title" id="contact-form" style="text-align: left; ">&nbsp;&nbsp;&nbsp;</h5> <div class="contacten" name="quick_enq_side"> <div class="panel panel-default"> <div class="panel-heading"> <h3 class="panel-title" style="font-size:15px;font-weight:bold;"> </h3> </div> <div class="panel-body">
<div id="forms" class="menu">
			
				<form action="" method="post" enctype="multipart/form-data">
					
		<div class="file-upload"> <label for="upload1" class="file-upload__label">Choose File </label> 
				<input id="upload1" class="file-upload__input" type="file" name="images1">
				</div>
				</br></br>				
					
				<div class="file-upload"> <label for="upload2" class="file-upload__label">Choose File </label> 
				<input id="upload2" class="file-upload__input" type="file" name="images2">
				</div>
				</br></br>				
					
						<div class="file-upload"> <label for="upload3" class="file-upload__label">Choose File </label> 
				<input id="upload3" class="file-upload__input" type="file" name="images3">
				</div>
				</br></br>	
				...
				<div id="jdiv">
					<input type="button" onclick="addfile();" class="knob knob-data" value="Add Input File" style="font-size:11pt;color:white;background-color:#ff7a59;border:2px solid #ff7a59;">
...
<script type="text/javascript">
						function addfile()
						{
							...
							cnt = ++cnt;
							var n = cnt + 2;
							var content = " </br><div id='bdiv_"+cnt+"'><div class='file-upload'> <label for='upload["+n+"]' class='file-upload__label'>Choose File </label><span id='spimg["+n+"]'> </span> <input type='file' class='file-upload__input' name='images"+n+"' id='upload["+n+"]' onclick='load_image(this.id)'/><span id='spimg["+n+"]'></span></div><div style='display:inline;' id='cdiv'><a href='javascript:removefile(this,"+cnt+");' id='file_"+cnt+"'>&nbsp;&nbsp;&nbsp;<input type='button' id='delete' name='delete' value='&times;' class='knob knob-data' style='font-size:11pt;color:#ff7a59;background-color:white;border:2px solid #ff7a59;'/></a></div></div>";
							if(cnt==2)
							{
							}
							$('#idiv').append(content);
...
<input name="speed" class="form-control" maxlength="10" type="text" style="text-align:left" placeholder="Speed in milliseconds" onKeyPress="return isNumberKey(event)" autocomplete="off" spellcheck="false" required><br><br>
						
	</div> 					
						
<div class="form-field">							
						
<input name="width" class="form-control" maxlength="4" type="text" placeholder="Width in pixels" onKeyPress="return isNumberKey(event)" autocomplete="off" spellcheck="false" required><br><br>
</div>					
