...
</script></div> </br> </br> <div id="former-text-list" class="bag_24"> <div class="property-content-divider"></div> <div id='before-cont-box-1' class='column_3_of_3 home-cont-box'> <div class='list-text-cover'> <div class="cont_col_1 widget_text secondary_object_category"> <div class="textwidget"> <p style="color:black; text-align:center; font-size:20px;"> </p> <div class="drop-accordion"> <h5 class="panel-title" id="contact-form" style="text-align: left; ">&nbsp;&nbsp;&nbsp;</h5> <div class="contacten" name="quick_enq_side"> <div class="panel panel-default"> <div class="panel-heading"> <h3 class="panel-title" style="font-size:15px;font-weight:bold;"> </h3> </div> <div class="panel-body"><a href="add_cards.php"> <button type="button" class="knob knob-data" style="font-size:12pt;color:white;background-color:#3A5580;border:2px solid #3A5580;padding:3px;width:90; height:48"> &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"></i> Add New Card&nbsp;&nbsp;&nbsp;&nbsp;</button> </a></br> </br><table id = "myTable1"><thead><tr style ="color:#3A5580;"> <th>Title</th> <th>Card</th> <th>Action</th> </tr> </thead> <tbody id="table-body">
    ...
    if (count($cardsResults) > 0) {
        ...
        foreach ($cardsResults as $rs) {
            ...
            <tr>
                ...
                <td>
                    <a href="edit_cards.php?edit=<?php echo ($rs["card_id"]); ?>" ><span  style='font-size:20px; color:#3A5580;'><i class='fa fa-edit' aria-hidden='true'></i></span></a> &nbsp;
                    <a href="manage_cards.php?del=<?php echo ($rs["card_id"]); ?>" onclick="return confirm('Are you sure?');"><span  style='font-size:20px; color:#ec5252;'><i class='fa fa-times' aria-hidden='true'></i></span></a> </td>
            </tr>
            <?php
        }
    } else {
...
<?php 
		...
		echo '<div class="boxed shaded"> <p style="font-size:15px; text-align:center;color:black"><strong>No Cards Found.</strong> </p> </div>';
