...
<div id="notes"> <div> <table id="cts"> <thead> <tr> <th>Title</th> <th>Date</th> <th>Action<br></th> </tr> </thead> <tbody><tr>
<?php foreach ($notes as $row): ?>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a class="pointer" title="Download this note" href="?dl=<?= $row['ID'] ?>" target="_blank"><span  style='font-size:20px; color:#3A5580;'><i class='fa fa-download' aria-hidden='true'></i></span></a> |
                                
								<a class ="pointer" title="Delete this note" onclick="deleteNote(<?= $row['ID'] ?>)"><span  style='font-size:20px; color:#ec5252;'><i class='fa fa-times' aria-hidden='true'></i></span></a>   
