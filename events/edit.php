...
if(isset($_POST['submit_btn'])) {
        ...
        $query = "UPDATE events_info SET name=?, description=?, deadline=?, status=?  WHERE id=?";
...
$query = "SELECT * FROM events_info WHERE id=?";
